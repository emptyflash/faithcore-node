...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.faithcoin');
  var defaultConfigFile = path.resolve(defaultPath, './faithcore-node.json');
      ...
      servicesConfig: {
        bitcoind: {
          spawn: {
            ...
            exec: path.resolve(__dirname, '../../bin/faithcoind')
          }
        }
      }
    };
